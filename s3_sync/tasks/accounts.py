...
def query(limit: str):
    return f"SELECT id, avatar_file_name, avatar_content_type, avatar_remote_url, header_file_name, header_content_type, header_remote_url FROM accounts WHERE id>0 ORDER BY id {limit};"
